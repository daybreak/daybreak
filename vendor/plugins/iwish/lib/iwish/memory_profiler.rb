class MemoryProfiler
  ...
  def self.start(opt={})
    ...
    Thread.new do
      ...
      file = File.open('/var/www/daybreak/log/memory_profiler.log','w')
      ...
      loop do
        begin
          ...
          if opt[:string_debug]
            File.open("/var/www/daybreak/log/memory_profiler_strings.log.#{Time.now.to_i}",'w') do |f|
